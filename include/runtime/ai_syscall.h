...
#define SYS_SLM_HW_SNAPSHOT         0x720  /* Read hardware + memory fabric + agent tree + pipeline snapshot */
...
#define AIOS_BOOTSTRAP_INFO_ABI_VERSION  3u
