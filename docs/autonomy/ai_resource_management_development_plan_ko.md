...
완료된 bounded native K2-a oracle 다음에 H1 OS-neutral trace/replay를 고정하고,
그 뒤 Linux-hosted 기본 delivery H2/H3로 진행한다. upstream Linux/QEMU/VirtIO
...
schema 고정이다. 다만 전역 직접 우선순위는 bounded native K2-a 뒤의 H1 replay,
