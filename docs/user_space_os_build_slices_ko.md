...
- static ELF loader
- `aios-init`
- userspace safety boundary (`copy_from_user`, `access_ok`)
...
- syscall surface는 있지만, 진짜 ring3 caller를 받기 위한 safety boundary는 아직 얕다
...
- 잘못된 userspace 주소가 panic이 아니라 에러 코드로 돌아감
