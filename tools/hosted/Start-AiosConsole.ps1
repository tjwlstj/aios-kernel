...
if ($Agent -or $AgentSmoke -or $ResourceSmoke -or $CellSmoke -or $BackendSmoke) {
...
if ($Agent -or $AgentSmoke -or $ResourceSmoke -or $CellSmoke -or $BackendSmoke) { $consoleArgs += @('--inference-cache', $InferenceCache) }
